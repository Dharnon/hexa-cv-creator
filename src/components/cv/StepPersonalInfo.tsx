  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Datos básicos de contacto</p>
      </div>
      ...
      <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
        ...
        />
        <Label className="text-sm">Mostrar información personal en el CV</Label>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          <Label>Nombre completo *</Label>
          <Input value={info.fullName} onChange={(e) => update('fullName', e.target.value)} placeholder="Juan Pérez García" />
        </div>
        <div className="space-y-2">
          <Label>Email *</Label>
        ...
        <div className="space-y-2">
          ...
          <Input value={info.address} onChange={(e) => update('address', e.target.value)} placeholder="Madrid, España" />
        </div>
        <div className="space-y-2">
        ...
        <div className="space-y-2">
          ...
          <Input value={info.nationality} onChange={(e) => update('nationality', e.target.value)} placeholder="Española" />
        </div>
        <div className="space-y-2">
